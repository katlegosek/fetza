...
Phase-1 polish ideas not yet implemented. Shipped work is summarized at the
bottom under **Implemented**. (Core flows: review fixes + even split are in
the app — see Implemented.)
...
- [ ] **Steal ideas responsibly** — periodically review how top-tier apps
      ...
      proprietary assets) so Fetza stays modern **on top of** [BRD.md](./BRD.md)
      and [ROADMAP.md](./ROADMAP.md). Track candidates in this
      backlog or a short rotating checklist when kicking off a phase.
