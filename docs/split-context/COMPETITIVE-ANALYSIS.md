...
**Purpose:** Clarify what this product (**Split**, working title) shares with established players and where differentiation is realistic.  
...
| | **Splitwise** | **Splitfair** | **This product (Split)** |
|--|----------------|----------------|---------------------------|
...
| Theme | Splitwise | Splitfair | Split (this app) |
|-------|-----------|-----------|-------------------|
...
## 5. Differences: where Split (this app) can stand apart

Use this internally to avoid **feature-chasing** Splitwise’s decade of scope.

### 5.1 vs Splitwise

| Dimension | Splitwise | Split (intended) |
|-----------|-----------|------------------|
...
| Dimension | Splitfair | Split (intended) |
|-----------|-----------|------------------|
